...
def start_game():
  ...
  elif roll_dices[dice_iterator] >= 7 and roll_dices[dice_iterator] <= 10:
...
while True:
  try:
    ...
    if turn == "p":
      # retira score de cérebros antigo, soma com a quantidade nova e checa o score para aviso de que ganhou
      ...
      if player_scoreboard[player_turn_iterator][1] >= 13:
        ...
        break
      elif dice_iterator == 3:
        dice_iterator = 0
        start_game()
      # retira score de tiros antigo, soma com a quantidade nova e checa o score para aviso de que perdeu
